    ...
    <section class="request-section--manually">
        <div class="csv-wrap">
            <div style="width: 400px">
                <label for="file-upload" class="btn request-btn" data-modal="modal-request1" style="max-width: 400px">
            ...
            <div>
                <a href="/download-csv-example" class="csv-btn">Пример файла</a>
            </div>
        </div>
        ...
        <div class="request-form">
            <div class="request-form__wrapper">
                <form id="request-form" name="request-form" method="post">
                    ...
                    <div class="field-group">
                        <input type="text" :value="vol" id="p-volume" class="text" placeholder="Объем, м3" name="volume">
