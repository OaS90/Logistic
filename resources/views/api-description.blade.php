    ...
    <div id="contain" class="layout">
        ...
        <div class="layout__right">
            ...
            <section class="applications-section">
                ...
                <p>Доступ к функции осуществляется методом POST по
                ...
                <table class="api-table">
                    ...
                    <tr>
                        ...
                        <td>ссылка на pdf наклейку (ссылка актуальна в течении недели с момента
                            создания). По истечению времени нужно запросить снова.
                        </td>
                        <td>обязательный параметр</td>
                    </tr>
                    <tr>
                ...
                {{--            <p>Пример запроса на создание заявки:</p>--}}
                ...
                {{--                ]--}}
                {{--            </pre>--}}
                {{--                <p>Запрос для загрузки стикеров:</p>--}}
                {{--                <p>[orderId] - номер заказа партнёра</p>--}}
                {{--                <p>[GET] <b>api/v1/order/{orderId}/stickers</b></p>--}}
            </section>
        </div>
    </div>
@endsection
