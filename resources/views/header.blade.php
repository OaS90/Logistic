<header class="navbar-header">
    ...
    <div class="navbar-personal">
        <div class="personal__help" title="Помощь">
            <svg class="help-svg" width="20" height="20" viewBox="0 0 20 20" fill="none"
        ...
        <div class="personal__user">
                   <span class="user-avatar">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M4 22C4 19.8783 4.84285 17.8434 6.34314 16.3431C7.84344 14.8429 9.87827 14 12 14C14.1217 14 16.1566 14.8429 17.6568 16.3431C19.1571 17.8434 20 19.8783 20 22H18C18 20.4087 17.3679 18.8826 16.2426 17.7574C15.1174 16.6321 13.5913 16 12 16C10.4087 16 8.88258 16.6321 7.75736 17.7574C6.63214 18.8826 6 20.4087 6 22H4ZM12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13ZM12 11C14.21 11 16 9.21 16 7C16 4.79 14.21 3 12 3C9.79 3 8 4.79 8 7C8 9.21 9.79 11 12 11Z"
                                fill="white"/>
                        </svg>
                   </span>
            ...
            <span class="user-btn">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12.0002 13.172L16.9502 8.222L18.3642 9.636L12.0002 16L5.63623 9.636L7.05023 8.222L12.0002 13.172Z"
                                fill="#888888"/>
                        </svg>
                   </span>
        </div>
