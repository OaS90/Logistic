...
@if(backpack_user()->hasRole('Логисты') || backpack_user()->hasRole('admin'))
    ...
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('quotes') }}'> <i class="las la-clock"></i> Квоты</a>
    </li>
    @if(!backpack_user()->hasRole('guest'))
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('quote-emails') }}'><i
                        class="las la-user-tie"></i>Email уведомления по квотам</a></li>
    @endif
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('regions') }}'><i class='nav-icon la la-map'></i>Регионы</a>
    </li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('quote-warehouse') }}'><i
                    class='nav-icon la la-store'></i>Склады по квотам</a></li>
@endif
<!-- Users, Roles, Permissions -->

@if(backpack_user()->hasRole('quotes'))
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('quotes') }}'><i class="las la-user-tie"></i>
            Квоты</a></li>
@endif
