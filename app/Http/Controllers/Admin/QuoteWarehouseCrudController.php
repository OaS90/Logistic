...
use App\Http\Requests\QuoteWarehouseRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class QuoteWarehouseCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class QuoteWarehouseCrudController extends CrudController
{
    ...
    {
        CRUD::setValidation(QuoteWarehouseRequest::class);

        CRUD::field('id');
        CRUD::field('warehouse_name');
