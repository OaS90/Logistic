...
class ApplicationApiCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            '*.address.flat' => 'string|min:1',
            '*.products' => 'required|array|min:1',
            '*.products.*.name' => 'required|string|min:1',
            '*.products.*.brand' => 'string|min:1|nullable',
            '*.products.*.sku' => 'required|string|min:1',
            '*.products.*.tnved' => 'string|min:1',
            '*.products.*.country' => 'string|min:1|nullable',
            '*.products.*.barcode' => 'string|nullable',
            '*.products.*.count' => 'required|integer|min:1',
            '*.products.*.cost' => 'required|numeric|min:1',
            '*.products.*.VATRate' => 'required|integer|min:0',
