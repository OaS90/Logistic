...
return [
    ...
    'publisher' => [
        'sasl' => [
            'mechanisms' => env('KAFKA_PUBLISHER_SASL_MECHANISMS', 'PLAIN'),
            'username' => env('KAFKA_PUBLISHER_SASL_USERNAME'),
            'password' => env('KAFKA_PUBLISHER_SASL_PASSWORD')
        ]
    ],

    'consumer' => [
        'sasl' => [
            'mechanisms' => env('KAFKA_CONSUMER_SASL_MECHANISMS', 'PLAIN'),
            'username' => env('KAFKA_CONSUMER_SASL_USERNAME'),
            'password' => env('KAFKA_CONSUMER_SASL_PASSWORD')
        ]
    ],

    'ssl' => [
        'ca' => [
            'location' => env('KAFKA_CA_LOCATION'),
        ],
        'certificate' => [
            'location' => env('KAFKA_CLIENT_CERT_LOCATION'),
        ],
        'key' => [
            'location' => env('KAFKA_CLIENT_KEY_LOCATION'),
            'password' => env('KAFKA_CLIENT_KEY_PASSWORD'),
        ]
    ]
];
